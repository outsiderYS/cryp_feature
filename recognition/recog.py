...
def parse_args():
    ...
    parser.add_argument('--train_folder_path', type=str, default='../stft/freq_ten_entropy_png/{}/{}'
                        .format(ratio, resolution))
    parser.add_argument('--test_folder_path', type=str, default='../stft/testdl/{}/{}'.format(ratio, resolution))
    ...
    parser.add_argument('--load_dir', type=str, default='model/{}/{}'.format(ratio, resolution))
    parser.add_argument('--save_dir', type=str, default='model/{}/{}'.format(ratio, resolution))
